...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Throw the pizza with the given power
            function throwPizza(throwPower) {
                pizzaThrown = true;
                
                // Calculate throw power
                throwPower = 0.5 + (powerLevel / 300) * 2.0;
            ...
            // Handle releasing power and throwing
            function releaseAndThrow() {
                if (powerCharging) {
                    // Stop charging and throw
                    clearInterval(chargeInterval);
                    powerCharging = false;
                    
                    let throwPower = powerLevel / 300;
                    throwPizza(throwPower);
                    return true;
                }
                return false;
            }
